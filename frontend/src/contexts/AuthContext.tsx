...
interface AuthContextType {
  ...
  isLoading: boolean;
  error: string | null;
  login: (username: string | LoginCredentials, password?: string) => Promise<User>;
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const login = async (username: string | LoginCredentials, password?: string): Promise<User> => {
    setIsLoading(true);
    setError(null);
    try {
      ...
      const loginParams: LoginCredentials = typeof username === 'object' ?
        username : // Already an object with username and password
        { username, password: password! }; // Convert to object for API call
